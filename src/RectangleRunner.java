...
//        int totalSquareFeet = plot1.calculateArea() + plot2.calculateArea() + plot3.calculateArea();
//        System.out.println("These three plots requires " + totalSquareFeet + " square feet of seed");
